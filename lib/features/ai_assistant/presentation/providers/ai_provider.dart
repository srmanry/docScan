...
class AiNotifier extends StateNotifier<AiState> {
  ...
  AiNotifier(this._summarize, this._translate, this._askQuestion)
    : super(const AiIdle());

  Future<void> summarize(String text, {String? language}) => _dispatch(
    () => _summarize(SummarizeParams(text: text, language: language)),
  );
  ...
  Future<void> ask(
    ...
    () => _askQuestion(
      AskQuestionParams(context: context, question: question, history: history),
    ),
  );
