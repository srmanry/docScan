...
class AiRemoteDataSourceImpl implements AiRemoteDataSource {
  ...
  AiRemoteDataSourceImpl({http.Client? client}) : _client = client ?? http.Client();
  ...
  @override
  Future<String> translate(String text, String targetLanguage) =>
      _generate('Translate the following document to $targetLanguage. '
          'Return only the translation, no extra commentary:\n\n$text');

  @override
  Future<String> answerQuestion(String context, String question) => _generate(
      'Using only the following document as context, answer the question.\n\n'
      'Document:\n$context\n\nQuestion: $question');
